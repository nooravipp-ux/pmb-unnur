          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Form | Upload Dokumen Kelengkapan Data Calon Mahasiswa</h2>
...
$( document ).ready(function() {   
    ...
    $("#d_gambar_ket_sehat").hide(); 
            ...
            success:function(data){
                ...
                if(data.file_ktp == null && data.file_kk == null && data.file_foto == null && data.file_ijazah == null && data.file_akta == null && data.file_ket_sehat == null){
                  $("#d_gambar_ktp").hide();
                  $("#d_gambar_kk").hide();
                  $("#d_gambar_foto").hide();
                  $("#d_gambar_ijazah").hide();
                  ...
                  $("#d_gambar_kk").show();
                  $("#d_gambar_foto").show();
                  $("#d_gambar_ijazah").show();
                  $("#d_gambar_akta").show();
                  $("#d_gambar_ket_sehat").show();
                }
