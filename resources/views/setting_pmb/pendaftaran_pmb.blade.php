                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                            method="POST" action="{{url('/pengaturan/pendaftaran-pmb/simpan-data-pmb')}}">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align"
                                    for="last-name">Gelombang<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Tanggal
                                    Selesai<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                                    ...
                                                    <form method="POST" action="{{route('pmb.delete', $data->id_pmb)}}">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="submit" data-toggle="tooltip"
                                                                ...
                                                                class="btn btn-danger btn-sm delete-pmb"><i
